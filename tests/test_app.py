...
MOCK_QUOTE = {'c': 150.0, 'd': -2.5, 'dp': -1.64, 'h': 155.0, 'l': 149.0, 'o': 152.0, 'pc': 152.5}
...
def test_api_assets(client, mocker):
    ...
    mocker.patch('app.services.finnhub_service.finnhub_client.quote', return_value=MOCK_QUOTE)
    mocker.patch('app.services.finnhub_service.finnhub_client.company_profile2', return_value=MOCK_PROFILE)
    mocker.patch('app.services.finnhub_service.finnhub_client.forex_rates', return_value=MOCK_FOREX)
